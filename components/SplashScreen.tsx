          ...
          >
            ...
            >
              <View style={styles.productBorder}>
                <Image 
                  source={require('@/assets/images/Scrap Rates Photos/Brass.jpg')}
            ...
            >
              <View style={styles.productBorder}>
                <Image 
                  source={require('@/assets/images/Scrap Rates Photos/Laptops.jpg')}
                  style={styles.productImage}
                />
              </View>
            </Animated.View>
            ...
            >
              <View style={styles.productBorder}>
                <Image 
                  source={require('@/assets/images/Scrap Rates Photos/Motors.jpg')}
                  style={styles.productImage}
                />
              </View>
            </Animated.View>
            ...
            >
              <View style={styles.productBorder}>
                <Image 
                  source={require('@/assets/images/Scrap Rates Photos/Copper.jpg')}
                  style={styles.productImage}
                />
              </View>
            </Animated.View>
